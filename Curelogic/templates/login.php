  ...
  <div class="wrap">
    ...
    <div class="loginSection">
      ...
      <section class="loginForm">
        <form action="../backend/patients/validate.php" method="POST">
          <div class="parent">
            <div class="child">
            ...
            <div class="child">
              <a href="register.php"><span style="color: goldenrod;">&nbspDon't&nbsphave&nbspan</span><span style="color:black">&nbspaccount?</span></a>
            </div>
          </div>
        </form>
      </section>
