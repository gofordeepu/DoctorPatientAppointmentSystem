          ...
          <?php
              ...
              while($row=mysqli_fetch_assoc($result))
              {
               ...
               echo"<tr>
                 ...
                 <td>".$row['Mobile']."</td>
                 <td>Approved</td>
                 <td><button class='action approve completed' value={$row['ApId']} type='submit' name='completed'>&#10003;Completed</button>
                 </td>
                 </tr>";
              }
              echo "</table></form>";
